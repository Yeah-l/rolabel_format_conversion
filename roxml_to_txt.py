...
def start(xml_path,filename,txt_path):
    ...
    for object in root.findall('object'): 
        ...
        file_object.write(str(x1)+' '+str(y1)+' '+str(x2)+' '+str(y2)+' '+str(x4)+' '+str(y4)+' '+str(x3)+' '+str(y3)+' '+name + ' ' + '0'  '\n')
    file_object.close()
...
if __name__ == "__main__":
    xml_path = r'E:\Data\\picture\\train\\annotations'
    save_txt_path = r'E:\Data\\picture\\train\\labelTxt'
